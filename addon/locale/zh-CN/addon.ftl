...
service-chatgpt-dialog-concurrencyLimit=并发限制
service-chatgpt-dialog-concurrencyLimit-placeholder=0 表示不限制
...
service-azuregpt-dialog-concurrencyLimit=并发限制
service-azuregpt-dialog-concurrencyLimit-placeholder=0 表示不限制
